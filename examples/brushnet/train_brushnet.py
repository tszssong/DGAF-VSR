...
# class load_gt(data.Dataset):
#     def __init__(self, opt):
#         super(load_gt, self).__init__()
#         self.opt = opt
#         self.gt_folder = opt['train_data_dir']
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        # default=["examples/brushnet/src/example_1_mask.jpg","examples/brushnet/src/example_2_mask.jpg","examples/brushnet/src/example_3_mask.jpg","examples/brushnet/src/example_5_mask.jpg"],
        nargs="+",
        help=(
            "A set of paths to the paintingnet conditioning image be evaluated every `--validation_steps`"
            " and logged to `--report_to`. Provide either a matching number of `--validation_prompt`s, a"
...
class MyWebDataset():
    ...
    def __call__(self,examples):
        ...
        for example in examples:
            # print(type(example))
            # print(example.keys)
            # print("image:", example["image"], example["image"].size)
            # caption=example["caption"].decode('utf-8')
            # height=int(example["height"].decode('utf-8'))
            # width=int(example["width"].decode('utf-8'))
            ...
            # print(f"catption:{caption}, {image.shape}")
