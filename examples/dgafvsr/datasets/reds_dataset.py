...
class REDSRecurrentDataset(data.Dataset):
    ...
    def __len__(self):
        return len(self.keys)
'''    
from .random_degradations import RandomBlur, RandomResize, RandomNoise, RandomJPEGCompression, RandomVideoCompression
class RealVSRRecurrentDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        print(out_dict['lqs'].shape, out_dict['gts'].shape)
        ## the first degradation
