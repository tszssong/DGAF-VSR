...
if __name__ == "__main__":
    ...
    parser.add_argument('--lst', type=str, default='/mnt/nfs0/hanzhang/data/style/crayon/test/lq.lst', help='')
    parser.add_argument('--gt', type=str, default='/mnt/nfs0/hanzhang/data/style/crayon/test/gt', help='')
    parser.add_argument('--out', type=str, default='', help='')
    parser.add_argument('--lora', type=str, default='/large/hanzhang/LoRA/SDXL/crayon/960x1_0814-210348/checkpoint-10000', help='')
    parser.add_argument('--word', type=str, default='drawing', help='')
