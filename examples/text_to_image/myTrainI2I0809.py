    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(unet):
                ...
                total_num_denoise = noise_scheduler.config.num_train_timesteps
                start_num_denoise = int(total_num_denoise*(1-0.5))
                timesteps = torch.randint(  
                    start_num_denoise, total_num_denoise, (bsz,), device=model_input.device
                )
